...
Build strong Python fundamentals and progress toward AI-powered applications.
...
1. Age Calculator
   ...
   * Takes year of birth as input
   * Calculates current age using the current year

2. Password Checker

   * Takes username and password as input
   * Masks the password using asterisks
